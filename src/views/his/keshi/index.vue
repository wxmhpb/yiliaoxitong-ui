...
<script>
import { listKeshi, getKeshi, delKeshi, addKeshi, updateKeshi } from "@/api/his/keshi";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('his/keshi/export', {
        ...this.queryParams
      }, `keshi_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
